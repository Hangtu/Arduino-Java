...
public class Escribir extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        java.io.PrintWriter archivoSalida;
        
        int i=chooser.showOpenDialog(this);
        archivo= chooser.getSelectedFile();
        String ruta= archivo.getAbsolutePath();
        try {
            archivoSalida=new PrintWriter(new FileWriter(ruta,true));
            archivoSalida.print(jTextArea1.getText());
            archivoSalida.close();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        java.io.BufferedReader archivoEntrada;
        javax.swing.JFileChooser chooser =new javax.swing.JFileChooser();
        File archivo;
        String ruta;
        ...
        try {
            archivoEntrada =new BufferedReader(new FileReader(ruta));
            jTextArea1.setText("");
